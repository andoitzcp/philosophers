...
/*												+#+#+#+#+#+   +#+		   */
/*   Created: 2025/08/24 14:06:29 by acampo-p@		 #+#	#+#			 */
/*   Updated: 2025/08/24 15:00:14 by acampo-p@        ###   ########.fr       */
/*																			*/
/* ************************************************************************** */
...
#define ANNOUNCE_FORK "\e[0;36mhas taken a fork\e[0;37m"
#define ANNOUNCE_EAT "\e[0;32mis eating\e[0;37m"
#define ANNOUNCE_SLEEP "\e[0;34mis sleeping\e[0;37m"
#define ANNOUNCE_THINK "\e[0;33mis thinking\e[0;37m"
#define ANNOUNCE_DEATH "\e[0;31mdied\e[0;37m"
...
#define ERROR_STR_01 "philosophers: \
main: incorrect number of arguments\n"
#define ERROR_STR_02 "philosophers: main: not valid input parameters\n"
#define ERROR_STR_03 "philosophers: \
	main: number of philosophers exceeded maximum\n"
#define ERROR_STR_04 "philosophers: \
	main: number of philosophers must be a positive integer\n"
#define ERROR_STR_05 "philosophers: \
	main: parameters must be a positive integer\n"
#define ERROR_STR_06 "philosophers: jointhreads: orchttr"
#define ERROR_STR_07 "philosophers: jointhreads: thread"
#define ERROR_STR_08 "philosophers: initphilo: orchttr"
#define ERROR_STR_09 "philosophers: initphilo: thread"
